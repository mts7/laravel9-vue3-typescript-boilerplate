...
use App\Console\Commands\PsalmErrors;
use Mockery;
use Symfony\Component\Process\Process;
use Tests\TestCase;

/**
 * Tests for Psalm Error command
 *
 * @group command
 * @group quality
 */
class PsalmErrorsTest extends TestCase
{
	/**
	...
	{
		/** @var PsalmErrors $command */
		$command = $this->app->make(PsalmErrors::class);
